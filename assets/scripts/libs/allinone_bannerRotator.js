...
(function (f) {
    function J(a, b) {
        ...
        var c = f(a.currentImg.attr("data-text-id")).children(), g = 0;
        currentText_arr = [];
        c.each(function () {
            currentText_arr[g] = f(this);
            var e = currentText_arr[g].attr("data-initial-left"), c = currentText_arr[g].attr("data-initial-top");
            ...
            setTimeout(function () {
                ...
                var e = l.attr("data-final-left"), c = l.attr("data-final-top");
                b.responsive && (e = parseInt(e / (b.origWidth / b.width), 10), c = parseInt(c / (b.origWidth / b.width), 10));
                var g = 1;
                !0 == a.isVideoPlaying && (g = 0);
                l.animate({opacity: g, left: e + "px", top: c + "px"}, 1E3 * l.attr("data-duration"), function () {
    ...
    function I(a, b, f, g, e) {
        ...
        b == g.numberOfRows - 1 && f == g.numberOfColumns - 1 ? setTimeout(function () {
            a.animate({opacity: "1.0", width: h, height: l}, 1E3 * g.effectDuration / 3, "", function () {
                e.trigger("effectComplete")
            })
        }, m) : setTimeout(function () {
            a.animate({opacity: "1.0", width: h, height: l}, 1E3 * g.effectDuration / 3)
        }, m);
        m += G
    }
    ...
    function B(a, b, c, g, e, h, l, D) {
        ...
        if (r) {
            ...
            if ("fade" == e || "slideFromLeft" == e || "slideFromRight" == e || "slideFromTop" == e || "slideFromBottom" == e) L(h, b, c), g = f(".stripe:first", h), "fade" == e && (g.css({
                ...
                height: "100%",
                width: h.width() + "px"
            }), g.animate({opacity: "1.0"}, 2E3 * b.effectDuration, "", function () {
                h.trigger("effectComplete")
            })), "slideFromLeft" == e && (g.css({top: "0px", height: "100%", width: "0"}), g.animate({
                opacity: "1.0",
                width: h.width() + "px"
                ...
                height: "0",
                width: h.width() + "px"
            }), g.animate({opacity: "1.0", height: h.height() + "px"}, 1E3 * b.effectDuration, "", function () {
                h.trigger("effectComplete")
                ...
                width: h.width() + "px",
                top: h.height() + "px"
            }), g.animate({opacity: "1.0", top: 0, height: h.height() + "px"}, 1E3 * b.effectDuration, "", function () {
                h.trigger("effectComplete")
            }));
            0 <= e.indexOf("Stripes") && (L(h, b, c), g = 0 <= e.indexOf("Reverse") ? f(".stripe", h).myReverse() : f(".stripe", h), m = 100, i = 0, g.each(function () {
                var a = f(this);
                ("topBottomDroppingStripes" == e || "topBottomDroppingReverseStripes" == e) && a.css({top: "0px"});
                ("bottomTopDroppingStripes" == e || "bottomTopDroppingReverseStripes" == e) && a.css({bottom: "0px"});
                ("leftRightFadingStripes" == e || "leftRightFadingReverseStripes" == e) && a.css({
                    top: "0px",
                    height: "100%",
                    width: "0"
                });
                "asynchronousDroppingStripes" == e && (i % 2 ? a.css({top: "0px"}) : a.css({bottom: "0px"}));
                if ("leftRightFadingStripes" == e || "leftRightFadingReverseStripes" == e) {
                    ...
                    i == b.numberOfStripes - 1 ? setTimeout(function () {
                        a.animate({width: d + "px", opacity: "1.0"}, 800 * b.effectDuration, "", function () {
                            h.trigger("effectComplete")
                        })
                    }, m) : setTimeout(function () {
                        a.animate({width: d + "px", opacity: "1.0"}, 800 * b.effectDuration)
                    }, m)
                } else i == b.numberOfStripes - 1 ? setTimeout(function () {
                    a.animate({height: "100%", opacity: "1.0"}, 1E3 * b.effectDuration, "", function () {
                        h.trigger("effectComplete")
                    })
                }, m) : setTimeout(function () {
                    a.animate({height: "100%", opacity: "1.0"}, 1E3 * b.effectDuration)
                }, m);
                m += M;
                i++
            }));
            if (0 <= e.indexOf("Blocks")) {
                ...
                if (0 <= e.indexOf("Reverse")) var p = f(".block", h).myReverse(); else if ("randomBlocks" == e) {
                    c = f(".block", h);
                    var d;
                ...
                if ("randomBlocks" == e) {
                    ...
                    p.each(function () {
                        var a = f(this), d = a.width(), e = a.height();
                        a.css({width: "0", height: "0"});
                        i == s - 1 ? setTimeout(function () {
                            ...
                            a.animate({opacity: "1.0", width: d, height: e}, 1E3 * b.effectDuration / 3)
                        }, m);
                        m += G;
                        i++
                    })
    ...
    var H = "fade slideFromLeft slideFromRight slideFromTop slideFromBottom topBottomDroppingStripes topBottomDroppingReverseStripes bottomTopDroppingStripes bottomTopDroppingReverseStripes asynchronousDroppingStripes leftRightFadingStripes leftRightFadingReverseStripes topBottomDiagonalBlocks topBottomDiagonalReverseBlocks randomBlocks".split(" "),
        u, F, m = 100, M = 50, G = 25, C = !1, t = navigator.userAgent.toLowerCase();
    f.fn.allinone_bannerRotator = function (a) {
        ...
        return this.each(function () {
            ...
            b.wrap(c);
            b.after(g);
            var e = b.parent(".allinone_bannerRotator"), h = f(".bannerControls", e),
                c = f('<div class="bottomNavLeft"></div>'), g = f('<div class="bottomNav"></div>'),
                l = f('<div class="bottomNavRight"></div>');
            b.after(c);
            b.after(g);
            b.after(l);
            a.showAllControllers || h.css("display", "none");
            var m = f(".leftNav", e), r = f(".rightNav", e);
            m.css("display", "none");
            r.css("display", "none");
            a.showNavArrows && a.showOnInitNavArrows && (m.css("display", "block"), r.css("display", "block"));
            var k = f(".bottomNav", e), v = f(".bottomNavLeft", e), x = f(".bottomNavRight", e), z;
            k.css("display", "block");
            v.css("display", "block");
            x.css("display", "block");
            ...
            -1 != t.indexOf("ipad") || -1 != t.indexOf("iphone") || -1 != t.indexOf("ipod") || -1 != t.indexOf("webos") || -1 != c && 7 >= c ? e.append('<img id="curBgImgIos" src="' + d.current_imgInside.attr("src") + '" width="' + a.width + '" height="' + a.height + '">') : (e.css("background", 'url("' + d.current_imgInside.attr("src") + '") no-repeat'), a.responsive && (-1 == c || -1 != c && 9 <= c ? e.css({
            ...
            }) : 8 == c && e.css({filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + d.current_imgInside.attr("src") + "',sizingMethod='scale')"})));
            a.enableTouchScreen && (c = Math.floor(1E5 * Math.random()), e.wrap('<div id="bannerRotatorParent_' + c + '" style="position:relative;" />'), f("#bannerRotatorParent_" + c).width(a.width + 1), f("#bannerRotatorParent_" + c).height(a.height), e.css({
                cursor: "url(" + a.absUrl + "assets/styles/skins/hand.cur),url(" + a.absUrl + "assets/styles/skins/hand.cur),move",
                left: "0px",
                position: "absolute"
            ...
            e.bind("effectComplete", function () {
                var c = E();
                d.effectIsRunning = !1;
                -1 != t.indexOf("ipad") || -1 != t.indexOf("iphone") || -1 != t.indexOf("ipod") || -1 != t.indexOf("webos") || -1 != c && 7 >= c ? (f("#curBgImgIos", e).attr("src", d.current_imgInside.attr("src")), f("#curBgImgIos", e).width(a.width), f("#curBgImgIos", e).height(a.height)) : (e.css("background", 'url("' + d.current_imgInside.attr("src") + '") no-repeat'), a.responsive && (-1 == c || -1 != c && 9 <= c ? e.css({
                    "-webkit-background-size": a.width + "px " + a.height + "px",
                    "-moz-background-size": a.width + "px " + a.height + "px",
                    "-o-background-size": a.width + "px " + a.height + "px",
                    "-ms-background-size": a.width + "px " + a.height + "px",
            ...
            f(window).resize(function () {
                var c = E();
                doResizeNow = !0;
                -1 != navigator.userAgent.indexOf("Android") && (0 == a.windowOrientationScreenSize0 && 0 == window.orientation && (a.windowOrientationScreenSize0 = f(window).width()), 0 == a.windowOrientationScreenSize90 && 90 == window.orientation && (a.windowOrientationScreenSize90 = f(window).height()), 0 == a.windowOrientationScreenSize_90 && -90 == window.orientation && (a.windowOrientationScreenSize_90 = f(window).height()), a.windowOrientationScreenSize0 && (0 == window.orientation && f(window).width() > a.windowOrientationScreenSize0) && (doResizeNow = !1), a.windowOrientationScreenSize90 && (90 == window.orientation && f(window).height() > a.windowOrientationScreenSize90) && (doResizeNow = !1), a.windowOrientationScreenSize_90 && (-90 == window.orientation && f(window).height() > a.windowOrientationScreenSize_90) && (doResizeNow = !1), 0 == d.windowWidth && (doResizeNow = !1, d.windowWidth = f(window).width()));
                ...
                a.responsive && doResizeNow && (!1 !== u && clearTimeout(u), u = setTimeout(function () {
                    ...
                    if (c.origWidth != responsiveWidth || c.width100Proc) {
                        ...
                        e.width(c.width);
                        e.height(c.height);
                        -1 != t.indexOf("ipad") || -1 != t.indexOf("iphone") || -1 != t.indexOf("ipod") || -1 != t.indexOf("webos") || -1 != u && 7 >= u ? (f("#curBgImgIos", e).attr("src", d.current_imgInside.attr("src")), f("#curBgImgIos", e).width(c.width), f("#curBgImgIos", e).height(c.height)) : -1 == u || -1 != u && 9 <= u ? e.css({
                        ...
                        }) : 8 == u && e.css({filter: "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + d.current_imgInside.attr("src") + "',sizingMethod='scale')"});
